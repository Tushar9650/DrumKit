    ...
    function makeSound(keyPressed){
        switch(keyPressed){
            case "w":
                ...
                audio.play();
                document.querySelector("#title").innerHTML="Tuu!!";
                break;
            case "a":
                var audio = new Audio("sounds/tom-2.mp3");
                audio.play();
                document.querySelector("#title").innerHTML="Toh!!";
                break;
            case "s":
                var audio = new Audio("sounds/tom-3.mp3");
                audio.play();
                document.querySelector("#title").innerHTML="Doh!!";
                break;
            case "d":
                var audio = new Audio("sounds/tom-4.mp3");
                audio.play();
                document.querySelector("#title").innerHTML="Dooooohhh😁";
                break;
            case "j":
                var audio = new Audio("sounds/snare.mp3");
                audio.play();
                document.querySelector("#title").innerHTML="TTTTT";
                break;
            case "k":
                var audio = new Audio("sounds/crash.mp3");
                audio.play();
                document.querySelector("#title").innerHTML="😂cchhhhhhh";
                break;
            case "l":
                var audio = new Audio("sounds/kick-bass.mp3");
                audio.play();
                document.querySelector("#title").innerHTML="Dmmmmm🤷‍♀️";
                break;
